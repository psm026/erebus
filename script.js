          ...
          if (spec.spotify) {
            ...
            const discMat = new THREE.ShaderMaterial({
              ...
              fragmentShader: [
                ...
                '  vec3 vinyl = vec3(0.62, 0.66, 0.72) + vec3(0.16) * grooves * (0.35 + 0.65 * bands);',
                '  float sheen = pow(abs(cos(spin)), 8.0) * (1.0 - smoothstep(0.2, 0.95, r));',
                '  vinyl += vec3(1.0) * sheen * 0.85 + uColA * sheen * 0.25;',
                '  float label = 1.0 - smoothstep(0.30, 0.315, r);',
                '  vec3 labelCol = mix(vec3(0.80, 0.84, 0.90), uColA, 0.35) * (0.7 + 0.3 * sin(spin * 3.0));',
